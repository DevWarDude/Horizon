        ...
        <div className=" bg-[#E7816B] py-12 pt-16 px-5 mt-[-50px] lg:mt-[0px] rounded-2xl shadow-xl md:px-14  lg:py-16">
          <div className="flex flex-col items-center justify-center text-center gap-6 lg:flex-row xl:justify-between">
            <div className="flex flex-col gap-3 lg:gap-5">
              ...
              <span className="font-medium sm:font-normal opacity-85 lg:text-start sm:text-lg lg:w-[500px] bottom">
                Ready to take the next level? Contact us today and find out how
                our expertise can help your business grow.
              </span>
            </div>
            <Link className=" text-stone-600 tracking-wide bg-white rounded-lg px-7 py-4 font-medium shadow-2xl whitespace-nowrap link">
              GET IN TOUCH
            </Link>
          </div>
        </div>
      </div>
      <div className="flex flex-col justify-center items-center pt-64 lg:pt-40 gap-5 md:pt-72 sm:pt-60 px-8 md:mb-8 ">
